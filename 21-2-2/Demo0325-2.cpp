 ...
 */
 ...
 int main()
 {
     ...
     cout << "           7 to Right Triangle Judge app                     " << endl;
     ...
     {
         cout << "Your input is invalid, please input again(valid choice: 0 -- 7)" << endl;
     ...
     while(select)
     {
        if(1==select)
        {
            ...
            if(1==choice)
            {
                ...
                {
                    cout << "Your input is invalid, please input again(valid choice: 10000 -- 99999)" << endl;
                    cout << "Input a num: ";
                    cin >> num;
                }
            }
        ...
        else if(2==select)
        {
            ...
            if(1==choice)
            {
                ...
                while(year<1)
                {
                    cout << "Your input is invalid, please input again(valid choice: 1 -- OO)" << endl;
                    cout << "Input a year: ";
                    cin >> year;
                }
